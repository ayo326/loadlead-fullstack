...
const allNav: {
  ...
  { title: "Compliance",    url: "/owner-operator/compliance", icon: ShieldCheck, hint: "W-9, insurance, authority", role: "OWNER_OPERATOR"               },
  ...
  { title: "Shipper",       url: "/shipper",                   icon: PackagePlus, hint: "Active loads",             role: "SHIPPER",        exact: true  },
  { title: "Policy",        url: "/shipper/policy",            icon: FileText,    hint: "Carrier policy",           role: "SHIPPER"                      },
