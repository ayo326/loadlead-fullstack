 ...
 *   TALLY_WEBHOOK_SECRET    — HMAC signing key from Tally. If unset, the
...
export interface BetaConfig {
  ...
  readonly tallyWebhookSecret: string | null;
...
export function getBetaConfig(): BetaConfig {
  ...
  cached = {
    ...
    tallyWebhookSecret: process.env.TALLY_WEBHOOK_SECRET?.trim() || null,
...
export function isTallyConnected(): boolean {
  return getBetaConfig().tallyWebhookSecret !== null;
}
